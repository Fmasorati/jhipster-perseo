...
describe('JobHistory Management Update Component', () => {
  ...
  describe('ngOnInit', () => {
    it('Should call job query and add missing value', () => {
      ...
      const job: IJob = { id: 20394 };
      jobHistory.job = job;

      const jobCollection: IJob[] = [{ id: 2058 }];
    ...
    it('Should call department query and add missing value', () => {
      const jobHistory: IJobHistory = { id: 456 };
      const department: IDepartment = { id: 17657 };
      jobHistory.department = department;

      const departmentCollection: IDepartment[] = [{ id: 22399 }];
    ...
    it('Should call employee query and add missing value', () => {
      const jobHistory: IJobHistory = { id: 456 };
      const employee: IEmployee = { id: 28964 };
      jobHistory.employee = employee;

      const employeeCollection: IEmployee[] = [{ id: 30652 }];
    ...
    it('Should update editForm', () => {
      const jobHistory: IJobHistory = { id: 456 };
      const job: IJob = { id: 7586 };
      jobHistory.job = job;
      const department: IDepartment = { id: 10465 };
      jobHistory.department = department;
      const employee: IEmployee = { id: 895 };
      jobHistory.employee = employee;
