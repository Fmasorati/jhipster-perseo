...
describe('Job Management Update Component', () => {
  ...
  describe('ngOnInit', () => {
    it('Should call Task query and add missing value', () => {
      ...
      const tasks: ITask[] = [{ id: 32678 }];
      job.tasks = tasks;

      const taskCollection: ITask[] = [{ id: 5055 }];
    ...
    it('Should call Employee query and add missing value', () => {
      const job: IJob = { id: 456 };
      const employee: IEmployee = { id: 4601 };
      job.employee = employee;

      const employeeCollection: IEmployee[] = [{ id: 4205 }];
    ...
    it('Should update editForm', () => {
      const job: IJob = { id: 456 };
      const task: ITask = { id: 833 };
      job.tasks = [task];
      const employee: IEmployee = { id: 28519 };
      job.employee = employee;
