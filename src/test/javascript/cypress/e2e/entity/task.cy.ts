...
describe('Task e2e test', () => {
  ...
  describe('new Task page', () => {
    ...
    it('should create an instance of Task', () => {
      cy.get(`[data-cy="title"]`).type('failing supposing');
      cy.get(`[data-cy="title"]`).should('have.value', 'failing supposing');

      cy.get(`[data-cy="description"]`).type('detail psst');
      cy.get(`[data-cy="description"]`).should('have.value', 'detail psst');
