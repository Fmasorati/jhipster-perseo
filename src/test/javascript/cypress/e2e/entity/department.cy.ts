...
describe('Department e2e test', () => {
  ...
  const departmentSample = { departmentName: 'sternly thing' };
  ...
  describe('new Department page', () => {
    ...
    it('should create an instance of Department', () => {
      cy.get(`[data-cy="departmentName"]`).type('unimpressively miserable ick');
      cy.get(`[data-cy="departmentName"]`).should('have.value', 'unimpressively miserable ick');
