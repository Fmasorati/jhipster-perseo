...
describe('Employee e2e test', () => {
  ...
  describe('new Employee page', () => {
    ...
    it('should create an instance of Employee', () => {
      cy.get(`[data-cy="firstName"]`).type('Federica');
      cy.get(`[data-cy="firstName"]`).should('have.value', 'Federica');

      cy.get(`[data-cy="lastName"]`).type('Aprile');
      cy.get(`[data-cy="lastName"]`).should('have.value', 'Aprile');

      cy.get(`[data-cy="email"]`).type('Timoteo_Martines@gmail.com');
      cy.get(`[data-cy="email"]`).should('have.value', 'Timoteo_Martines@gmail.com');

      cy.get(`[data-cy="phoneNumber"]`).type('the empty political');
      cy.get(`[data-cy="phoneNumber"]`).should('have.value', 'the empty political');

      cy.get(`[data-cy="hireDate"]`).type('2024-01-09T02:40');
      cy.get(`[data-cy="hireDate"]`).blur();
      cy.get(`[data-cy="hireDate"]`).should('have.value', '2024-01-09T02:40');

      cy.get(`[data-cy="salary"]`).type('11469');
      cy.get(`[data-cy="salary"]`).should('have.value', '11469');

      cy.get(`[data-cy="commissionPct"]`).type('12282');
      cy.get(`[data-cy="commissionPct"]`).should('have.value', '12282');
