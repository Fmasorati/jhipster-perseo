...
describe('Location e2e test', () => {
  ...
  describe('new Location page', () => {
    ...
    it('should create an instance of Location', () => {
      cy.get(`[data-cy="streetAddress"]`).type('strafe');
      cy.get(`[data-cy="streetAddress"]`).should('have.value', 'strafe');

      cy.get(`[data-cy="postalCode"]`).type('impediment');
      cy.get(`[data-cy="postalCode"]`).should('have.value', 'impediment');

      cy.get(`[data-cy="city"]`).type('Bomporto');
      cy.get(`[data-cy="city"]`).should('have.value', 'Bomporto');

      cy.get(`[data-cy="stateProvince"]`).type('assembly');
      cy.get(`[data-cy="stateProvince"]`).should('have.value', 'assembly');
