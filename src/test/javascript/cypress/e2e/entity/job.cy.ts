...
describe('Job e2e test', () => {
  ...
  describe('new Job page', () => {
    ...
    it('should create an instance of Job', () => {
      cy.get(`[data-cy="jobTitle"]`).type('Investor Identity Coordinator');
      cy.get(`[data-cy="jobTitle"]`).should('have.value', 'Investor Identity Coordinator');

      cy.get(`[data-cy="minSalary"]`).type('4896');
      cy.get(`[data-cy="minSalary"]`).should('have.value', '4896');

      cy.get(`[data-cy="maxSalary"]`).type('7927');
      cy.get(`[data-cy="maxSalary"]`).should('have.value', '7927');
